...
#        sys.exit(1)
#    c = connDBI.cursor()
#    if c.execute('select * from microservices where port=?', (portNum,) ):
#        msExist=True#
#
#    msProps = msProps + "msTitle=" + msTitle + "\n"
#    if msExist:
#        msProps = msProps + "inDBAlready=yes\n"
#    else:
#        msProps = msProps + "inDBAlready=no\n"
...
print('git clone '+ctxtNme+'@'+msIpAdd+':/volume/'+ctxtNme+'/'+msTitle + '.git ' + msTempD)
os.system('git clone '+ctxtNme+'@'+msIpAdd+':/volume/'+ctxtNme+'/'+msTitle + '.git ' + msTempD)
...
#print("Waiting" + str(waittme) + " more seconds...")
#time.sleep(waittme)
# 8b. Wait a 2 minutes
...
#        sys.exit(1)
#    c = connDBI.cursor()
#    if c.execute('insert into microservices (port, properties) VALUE (%s, %s)', (portNum,msProps) ):
#        msExist=True
